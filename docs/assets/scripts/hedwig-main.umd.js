(function (global, factory) {
    ...
    class SystemUsage extends HTMLElement {
      constructor() {
        super();
      }
      /**
     ...
     * @description
     * @extends HTMLElement
     * Graph representing CPU min over time
     */

    class MinUsage extends HTMLElement {
      constructor() {
        super();
      }
      /**
     ...
     * @name FilesystemUsed
     * @description
     * Filesystem graph representing used
     * @extends HTMLElement
     */

    class FilesystemUsed extends HTMLElement {
      constructor() {
        super();
      }
      /**
      ...
      parseData(data) {
        ...
        for (var i = 0; i < data.length; i++) {
          var item = data[i].filesystem_used;
          results.push(item);
        }
    ...
    customElements.define('filesystem-used', FilesystemUsed);

    /**
     * @name FilesystemFreeFiles
     * @description
     * Graph representing number of filesystem free inodes
     * @extends HTMLElement
     */

    class FilesystemFreeFiles extends HTMLElement {
      constructor() {
        super();
      }
      /**
      ...
      parseData(data) {
        ...
        for (var i = 0; i < data.length; i++) {
          var item = data[i].filesystem_free_files;
          results.push(item);
        }
    ...
    class FilesystemFree extends HTMLElement {
      constructor() {
        super();
      }
      /**
     ...
     * @description
     * Graph representing total space on the filesystem, in kb includeing reserved space.
     * @extends HTMLElement
     */

    class FilesystemTotal extends HTMLElement {
      constructor() {
        super();
      }
      /**
      ...
      parseData(data) {
        ...
        for (var i = 0; i < data.length; i++) {
          var item = data[i].filesystem_total;
          results.push(item);
        }
    ...
    customElements.define('filesystem-total', FilesystemTotal);
    ...
    class MemoryActualUsed extends HTMLElement {
      constructor() {
        super();
      }
      /**
      ...
      render() {
        if (this.graphData && this.defaults) {
          this.innerHTML = "<line-graph data-margin=" + JSON.stringify(this.defaults.margin) + " data-height=" + this.defaults.height + " data-width=" + this.defaults.width + " data-graph=" + JSON.stringify(this.graphData) + " data-unit='b'" + " data-line-color=" + this.defaults.lineColor + "></lineGraph>";
        }
      }
      /**
       * @name dataPoints
    ...
    /**
     * @name MemoryActualFree
     * @extends HTMLElement
     * @description 
     * Graph component representing memory swap page in utilization
     */

    class MemoryActualFree extends HTMLElement {
      constructor() {
        super();
      }
      /**
      ...
      parseData(data) {
        ...
        for (var i = 0; i < data.length; i++) {
          var item = data[i].memory_actual_free;
          results.push(item);
        }
    ...
    customElements.define('memory-actual-free', MemoryActualFree);
    ...
    class MemoryFree extends HTMLElement {
      constructor() {
        super();
      }
      /**
    ...
    class MemoryRam extends HTMLElement {
      constructor() {
        super();
      }
      /**
      ...
      render() {
        if (this.graphData && this.defaults) {
          this.innerHTML = "<line-graph data-margin=" + JSON.stringify(this.defaults.margin) + " data-height=" + this.defaults.height + " data-width=" + this.defaults.width + " data-graph=" + JSON.stringify(this.graphData) + " data-unit='mb'" + " data-line-color=" + this.defaults.lineColor + "></lineGraph>";
        }
      }
      /**
       * @name dataPoints
    ...
    customElements.define('memory-ram', MemoryRam);
    ...
    class MemorySwapPageIn extends HTMLElement {
      constructor() {
        super();
      }
      /**
      ...
      parseData(data) {
        ...
        for (var i = 0; i < data.length; i++) {
          var item = data[i].memory_swap_page_in;
          results.push(item);
        }
    ...
    /**
     * @name MemorySwapPageOut
     * @extends HTMLElement
     * @description 
     * Graph component representing memory swap page out utilization
     */

    class MemorySwapPageOut extends HTMLElement {
      constructor() {
        super();
      }
      /**
      ...
      parseData(data) {
        ...
        for (var i = 0; i < data.length; i++) {
          var item = data[i].memory_swap_page_out;
          results.push(item);
        }
    ...
    customElements.define('memory-swap-page-out', MemorySwapPageOut);

    /**
     * @name MemoryTotal
     * @extends HTMLElement
     * @description
     * Graph component representing total memory
     */

    class MemoryTotal extends HTMLElement {
      constructor() {
        super();
      }
      /**
    ...
    customElements.define('memory-total', MemoryTotal);
    ...
    class NetworkRxFrame extends HTMLElement {
      constructor() {
        super();
      }
      /**
      ...
      parseData(data) {
        ...
        for (var i = 0; i < data.length; i++) {
          var item = data[i].network_rx_frame;
          results.push(item);
        }
     ...
     * @extends HTMLElement
     * @description
     * Graph component representing transmitted dropped packets
     */

    class NetworkTxDropped extends HTMLElement {
      constructor() {
        super();
      }
      /**
      ...
      parseData(data) {
        ...
        for (var i = 0; i < data.length; i++) {
          var item = data[i].network_tx_dropped;
          results.push(item);
        }
    ...
    customElements.define('network-tx-dropped', NetworkTxDropped);

    /**
     * @name NetworkTxBytes
     * @extends HTMLElement
     * @description
     * Graph component representing transmitted bytes
     */

    class NetworkTxBytes extends HTMLElement {
      constructor() {
        super();
      }
      /**
      ...
      parseData(data) {
        ...
        for (var i = 0; i < data.length; i++) {
          var item = data[i].network_tx_bytes;
          results.push(item);
        }
    ...
    /**
     * @name NetworkTxCollisions
     * @extends HTMLElement
     * @description
     * Graph component representing transmitted collisions
     */

    class NetworkTxCollisions extends HTMLElement {
      constructor() {
        super();
      }
      /**
      ...
      connectedCallback() {
        ...
        this.defaults.width = (this.dataset.width || defaults.graphWidth) - this.defaults.margin.left - this.defaults.margin.right;
        this.defaults.lineColor = this.dataset.lineColor || defaults.lineColor;
        this.defaults.unit = this.dataset.unit || 'collisions';
        this.render();
      }
      /**
       * @name parseData
      ...
      parseData(data) {
        ...
        for (var i = 0; i < data.length; i++) {
          var item = data[i].network_tx_collisions;
          results.push(item);
        }
    ...
    customElements.define('network-tx-collisions', NetworkTxCollisions);

    /**
     * @name NetworkTxCarrier
     * @extends HTMLElement
     * @description
     * Graph component representing network transmitted carrier
     */

    class NetworkTxCarrier extends HTMLElement {
      constructor() {
        super();
      }
      /**
      ...
      parseData(data) {
        ...
        for (var i = 0; i < data.length; i++) {
          var item = data[i].network_tx_carrier;
          results.push(item);
        }
    ...
    customElements.define('network-tx-carrier', NetworkTxCarrier);

    /**
     * @name NetworkTxOverruns
     * @extends HTMLElement
     * @description
     * Graph component representing transmitted overruns
     */

    class NetworkTxOverruns extends HTMLElement {
      constructor() {
        super();
      }
      /**
      ...
      parseData(data) {
        ...
        for (var i = 0; i < data.length; i++) {
          var item = data[i].network_tx_overruns;
          results.push(item);
        }
    ...
    customElements.define('network-tx-overruns', NetworkTxOverruns);

    /**
     * @name NetworkTxPackets
     * @extends HTMLElement
     * @description
     * Graph component representing number of packets transmitted
     */

    class NetworkTxPackets extends HTMLElement {
      constructor() {
        super();
      }
      /**
      ...
      parseData(data) {
        ...
        for (var i = 0; i < data.length; i++) {
          var item = data[i].network_tx_packets;
          results.push(item);
        }
    ...
    customElements.define('network-tx-packets', NetworkTxPackets);
    ...
    exports.FilesystemFree = FilesystemFree;
    exports.FilesystemTotal = FilesystemTotal;
    ...
    exports.NetworkTxDropped = NetworkTxDropped;
    exports.NetworkTxBytes = NetworkTxBytes;
    exports.NetworkTxCollisions = NetworkTxCollisions;
    exports.NetworkTxCarrier = NetworkTxCarrier;
    exports.NetworkTxOverruns = NetworkTxOverruns;
    exports.NetworkTxPackets = NetworkTxPackets;
