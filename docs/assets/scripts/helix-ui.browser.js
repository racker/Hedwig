(function (global, factory) {
    ...
    var HXAccordionElement = function (_HXElement) {
        ...
        createClass(HXAccordionElement, [{
            ...
            value: function $onDisconnect() {
                ...
                this.panels.forEach(function (panel) {
                    panel.removeEventListener('open', _this3._onPanelOpen);
                });
            }
        }, {
            key: '$onAttributeChange',
    ...
    var HXAccordionPanelElement = function (_HXElement) {
        ...
        function HXAccordionPanelElement() {
            ...
            return possibleConstructorReturn(this, (HXAccordionPanelElement.__proto__ || Object.getPrototypeOf(HXAccordionPanelElement)).apply(this, arguments));
        }

        createClass(HXAccordionPanelElement, [{
            key: '$onCreate',
            value: function $onCreate() {
    ...
    var HXCheckboxElement = function (_HXElement) {
        ...
        function HXCheckboxElement() {
            ...
            return possibleConstructorReturn(this, (HXCheckboxElement.__proto__ || Object.getPrototypeOf(HXCheckboxElement)).apply(this, arguments));
        }

        createClass(HXCheckboxElement, [{
            key: '$onCreate',
            value: function $onCreate() {
    ...
    var HXDisclosureElement = function (_HXElement) {
        ...
        function HXDisclosureElement() {
            classCallCheck(this, HXDisclosureElement);
            return possibleConstructorReturn(this, (HXDisclosureElement.__proto__ || Object.getPrototypeOf(HXDisclosureElement)).apply(this, arguments));
        }
     ...
     * @since 0.14.0
     */
    var HXDropFenceElement = function (_HXElement) {
        inherits(HXDropFenceElement, _HXElement);

        function HXDropFenceElement() {
            classCallCheck(this, HXDropFenceElement);
            return possibleConstructorReturn(this, (HXDropFenceElement.__proto__ || Object.getPrototypeOf(HXDropFenceElement)).apply(this, arguments));
        }

        createClass(HXDropFenceElement, null, [{
            key: 'is',
            get: function get$$1() {
    ...
    var HXDropZoneElement = function (_HXElement) {
        inherits(HXDropZoneElement, _HXElement);

        function HXDropZoneElement() {
            classCallCheck(this, HXDropZoneElement);
            return possibleConstructorReturn(this, (HXDropZoneElement.__proto__ || Object.getPrototypeOf(HXDropZoneElement)).apply(this, arguments));
        }

        createClass(HXDropZoneElement, [{
            key: '$onCreate',
            value: function $onCreate() {
            ...
            value: function _onDragLeave() {
                ...
                this._zoneDragLeaveTimeout = window.setTimeout(function () {
                    _this2._isZoneDragging = false;
                    _this2.setAttribute('drag', 'away');
                }, 0);
            }
     ...
     * @hideconstructor
     */
    var HXFileInputElement = function (_HXElement) {
        inherits(HXFileInputElement, _HXElement);

        function HXFileInputElement() {
            classCallCheck(this, HXFileInputElement);
            return possibleConstructorReturn(this, (HXFileInputElement.__proto__ || Object.getPrototypeOf(HXFileInputElement)).apply(this, arguments));
        }

        createClass(HXFileInputElement, [{
            key: '$onCreate',
            value: function $onCreate() {
                this._onClick = this._onClick.bind(this);
            }
     ...
     * @since 0.12.0
     */
    var HXFileTileElement = function (_HXElement) {
        inherits(HXFileTileElement, _HXElement);

        function HXFileTileElement() {
            classCallCheck(this, HXFileTileElement);
            return possibleConstructorReturn(this, (HXFileTileElement.__proto__ || Object.getPrototypeOf(HXFileTileElement)).apply(this, arguments));
        }

        createClass(HXFileTileElement, [{
            key: '$onCreate',
            value: function $onCreate() {
                this._onDismiss = this._onDismiss.bind(this);
    ...
    var HXIconElement = function (_HXElement) {
        ...
        function HXIconElement() {
            classCallCheck(this, HXIconElement);
            return possibleConstructorReturn(this, (HXIconElement.__proto__ || Object.getPrototypeOf(HXIconElement)).apply(this, arguments));
        }

        createClass(HXIconElement, [{
            key: '$onConnect',
            value: function $onConnect() {
                this.$upgradeProperty('type');
                this.$defaultAttribute('aria-hidden', true);
    ...
    var HXMenuElement = function (_HXElement) {
        ...
        function HXMenuElement() {
            ...
            return possibleConstructorReturn(this, (HXMenuElement.__proto__ || Object.getPrototypeOf(HXMenuElement)).apply(this, arguments));
        }
     ...
     * @since 0.2.0
     */
    var HXMenuitemElement = function (_HXElement) {
        inherits(HXMenuitemElement, _HXElement);

        function HXMenuitemElement() {
            classCallCheck(this, HXMenuitemElement);
            return possibleConstructorReturn(this, (HXMenuitemElement.__proto__ || Object.getPrototypeOf(HXMenuitemElement)).apply(this, arguments));
        }

        createClass(HXMenuitemElement, [{
            key: '$onConnect',
            value: function $onConnect() {
    ...
    var HXModalElement = function (_HXElement) {
        ...
        function HXModalElement() {
            ...
            return possibleConstructorReturn(this, (HXModalElement.__proto__ || Object.getPrototypeOf(HXModalElement)).apply(this, arguments));
        }

        createClass(HXModalElement, [{
            key: '$onCreate',
            value: function $onCreate() {
     ...
     * @since 0.8.0
     */
    var HXPillElement = function (_HXElement) {
        inherits(HXPillElement, _HXElement);

        function HXPillElement() {
            classCallCheck(this, HXPillElement);
            return possibleConstructorReturn(this, (HXPillElement.__proto__ || Object.getPrototypeOf(HXPillElement)).apply(this, arguments));
        }

        createClass(HXPillElement, [{
            key: '$onCreate',
            value: function $onCreate() {
                this._onDismiss = this._onDismiss.bind(this);
            }
    ...
    var HXPopoverElement = function (_HXElement) {
        ...
        function HXPopoverElement() {
            ...
            return possibleConstructorReturn(this, (HXPopoverElement.__proto__ || Object.getPrototypeOf(HXPopoverElement)).apply(this, arguments));
        }
    ...
    var HXRevealElement = function (_HXElement) {
        ...
        function HXRevealElement() {
            classCallCheck(this, HXRevealElement);
            return possibleConstructorReturn(this, (HXRevealElement.__proto__ || Object.getPrototypeOf(HXRevealElement)).apply(this, arguments));
        }

        createClass(HXRevealElement, [{
            key: '$onConnect',
            value: function $onConnect() {
                this.$upgradeProperty('open');
    ...
    var HXSearchElement = function (_HXElement) {
        ...
        function HXSearchElement() {
            ...
            return possibleConstructorReturn(this, (HXSearchElement.__proto__ || Object.getPrototypeOf(HXSearchElement)).apply(this, arguments));
        }

        createClass(HXSearchElement, [{
            key: '$onCreate',
            value: function $onCreate() {
             ...
             * @private
             */
            value: function _onClearClick(evt) {
                evt.preventDefault();
                this.clear();
                this.focus();
            }
            ...
            key: '_onSearchInput',
            value: function _onSearchInput(evt) {
                this.value = evt.target.value;
                var hasValue = evt.target.value !== '';
    ...
    var HXTabElement = function (_HXElement) {
        ...
        function HXTabElement() {
            classCallCheck(this, HXTabElement);
            return possibleConstructorReturn(this, (HXTabElement.__proto__ || Object.getPrototypeOf(HXTabElement)).apply(this, arguments));
        }

        createClass(HXTabElement, [{
            key: '$onConnect',
            value: function $onConnect() {
    ...
    var HXTablistElement = function (_HXElement) {
        ...
        function HXTablistElement() {
            classCallCheck(this, HXTablistElement);
            return possibleConstructorReturn(this, (HXTablistElement.__proto__ || Object.getPrototypeOf(HXTablistElement)).apply(this, arguments));
        }

        createClass(HXTablistElement, [{
            key: '$onConnect',
            value: function $onConnect() {
    ...
    var HXTabpanelElement = function (_HXElement) {
        ...
        function HXTabpanelElement() {
            ...
            return possibleConstructorReturn(this, (HXTabpanelElement.__proto__ || Object.getPrototypeOf(HXTabpanelElement)).apply(this, arguments));
        }
    ...
    var HXTabsetElement = function (_HXElement) {
        ...
        function HXTabsetElement() {
            classCallCheck(this, HXTabsetElement);
            return possibleConstructorReturn(this, (HXTabsetElement.__proto__ || Object.getPrototypeOf(HXTabsetElement)).apply(this, arguments));
        }
    ...
    var HXToastElement = function (_HXElement) {
        ...
        function HXToastElement() {
            ...
            return possibleConstructorReturn(this, (HXToastElement.__proto__ || Object.getPrototypeOf(HXToastElement)).apply(this, arguments));
        }
    ...
    var HXTooltipElement = function (_HXElement) {
        ...
        function HXTooltipElement() {
            ...
            return possibleConstructorReturn(this, (HXTooltipElement.__proto__ || Object.getPrototypeOf(HXTooltipElement)).apply(this, arguments));
        }
